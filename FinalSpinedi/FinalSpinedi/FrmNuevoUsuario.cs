                                ...
                                if (cbProvincia.Text == "")
                                {
                                    ...
                                    if (cbLocalidad.Text == "")
                                    {
                                        ...
                                        if (txtcp.Text == "")
                                        {
                                            ...
                                            {
                                                brl.agregarUsuario(txtnombre.Text, txtapellido.Text, txtdni.Text, dtpfecha_nac.Text, cbsexo.Text, txtcel.Text, txttel_fijo.Text, txtdomicilio.Text, cbProvincia.Text, cbLocalidad.Text, txtcp.Text, txtEmail.Text);
                                            }
        }
